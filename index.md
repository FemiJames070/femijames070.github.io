...
<div style="margin-top: 60px; margin-bottom: 40px; padding: 50px 25px; background: linear-gradient(135deg, #24292e 0%, #444d56 100%); border-radius: 12px; color: #ffffff; text-align: center; box-shadow: 0 10px 30px rgba(0,0,0,0.2); border: 1px solid rgba(255,255,255,0.1);">
  
  <div style="display: inline-block; background: rgba(255,255,255,0.1); padding: 8px 18px; border-radius: 50px; font-size: 0.75rem; font-weight: 700; text-transform: uppercase; letter-spacing: 2px; margin-bottom: 25px; border: 1px solid rgba(255,255,255,0.15);">
    Open Source & Contributions
  </div>

  <h2 style="color: #ffffff; margin-top: 0; margin-bottom: 20px; font-size: 2.25rem; font-weight: 800; line-height: 1.2;">
    Explore the Full Repository Ecosystem
  </h2>

  <p style="font-size: 1.15rem; color: #cbd5e0; max-width: 750px; margin: 0 auto 40px auto; line-height: 1.7;">
    Beyond these case studies, I maintain a library of <strong>automated workflows, ML experiments, and scalable backend architectures</strong>. Check out my latest commits and system designs.
  </p>

  <a href="https://github.com/FemiJames070" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; background-color: #ffffff; color: #24292e; padding: 18px 45px; border-radius: 10px; text-decoration: none; font-weight: 700; font-size: 1.25rem; transition: all 0.3s cubic-bezier(0.175, 0.885, 0.32, 1.275); box-shadow: 0 10px 20px rgba(0,0,0,0.3);" 
     onmouseover="this.style.transform='scale(1.05)'; this.style.boxShadow='0 15px 25px rgba(0,0,0,0.4)';" 
     onmouseout="this.style.transform='scale(1)'; this.style.boxShadow='0 10px 20px rgba(0,0,0,0.3)';">
    <svg height="28" width="28" viewBox="0 0 16 16" style="margin-right: 15px; fill: #24292e;">
